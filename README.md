...
Connect the Prime G2, open the Connectivity Kit on your computer, and drag
`SMDRES.hpprgm` onto the calculator in the file browser — it'll sit under
Programs, next to Meshtastic. Same method you've already been using for
every version of this file.
